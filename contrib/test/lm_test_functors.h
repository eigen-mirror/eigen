...
#ifndef EIGEN_TEST_LM_TEST_FUNCTORS_H
#define EIGEN_TEST_LM_TEST_FUNCTORS_H

// Residual functors for the MINPACK examples and the NIST StRD nonlinear regression problems, shared by
// NonLinearOptimization.cpp and levenberg_marquardt.cpp. The including file defines LmFunctorBase as the
// functor base class of the module under test; both modules define Eigen::LevenbergMarquardt, so this
// header includes neither.

struct lmder_functor : LmFunctorBase {
  lmder_functor(void) : LmFunctorBase(3, 15) {}
...
struct lmdif_functor : LmFunctorBase {
  lmdif_functor(void) : LmFunctorBase(3, 15) {}
  int operator()(const VectorXd &x, VectorXd &fvec) const {
    int i;
    double tmp1, tmp2, tmp3;
    static const double y[15] = {1.4e-1, 1.8e-1, 2.2e-1, 2.5e-1, 2.9e-1, 3.2e-1, 3.5e-1, 3.9e-1,
...
struct chwirut2_functor : LmFunctorBase {
  chwirut2_functor(void) : LmFunctorBase(3, 54) {}
...
struct misra1a_functor : LmFunctorBase {
  misra1a_functor(void) : LmFunctorBase(2, 14) {}
...
struct hahn1_functor : LmFunctorBase {
  hahn1_functor(void) : LmFunctorBase(7, 236) {}
...
struct misra1d_functor : LmFunctorBase {
  misra1d_functor(void) : LmFunctorBase(2, 14) {}
...
struct lanczos1_functor : LmFunctorBase {
  lanczos1_functor(void) : LmFunctorBase(6, 24) {}
...
struct rat42_functor : LmFunctorBase {
  rat42_functor(void) : LmFunctorBase(3, 9) {}
...
struct MGH10_functor : LmFunctorBase {
  MGH10_functor(void) : LmFunctorBase(3, 16) {}
...
struct BoxBOD_functor : LmFunctorBase {
  BoxBOD_functor(void) : LmFunctorBase(2, 6) {}
...
struct MGH17_functor : LmFunctorBase {
  MGH17_functor(void) : LmFunctorBase(5, 33) {}
...
struct MGH09_functor : LmFunctorBase {
  MGH09_functor(void) : LmFunctorBase(4, 11) {}
...
struct Bennett5_functor : LmFunctorBase {
  Bennett5_functor(void) : LmFunctorBase(3, 154) {}
...
struct thurber_functor : LmFunctorBase {
  thurber_functor(void) : LmFunctorBase(7, 37) {}
...
struct rat43_functor : LmFunctorBase {
  rat43_functor(void) : LmFunctorBase(4, 15) {}
...
struct eckerle4_functor : LmFunctorBase {
  eckerle4_functor(void) : LmFunctorBase(3, 35) {}
...
#endif  // EIGEN_TEST_LM_TEST_FUNCTORS_H
