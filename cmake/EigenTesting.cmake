...
macro(ei_add_test_internal testname testname_with_suffix)
  ...
  if(EIGEN_ADD_TEST_FILENAME_EXTENSION STREQUAL cu)
    ...
    if(EIGEN_TEST_HIP)
      hip_reset_flags()
      # FindHIP's custom compile commands do not consume the native HIP_ARCHITECTURES target property.
      set(hip_arch_flags "")
      foreach(arch IN LISTS EIGEN_HIP_ARCHITECTURES)
        list(APPEND hip_arch_flags "--offload-arch=${arch}")
      endforeach()
      hip_add_executable(${targetname} ${filename} HIPCC_OPTIONS -std=c++14 ${hip_arch_flags})
