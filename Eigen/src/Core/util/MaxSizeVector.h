...
class MaxSizeVector {
 ...
 public:
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr T* begin() { return m_data; }

  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr T* end() { return m_data + m_size; }

  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr const T* begin() const { return m_data; }

  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr const T* end() const { return m_data + m_size; }
