...
EIGEN_STRONG_INLINE Packet4Xi ploaddup<Packet4Xi>(const numext::int32_t* from) {
  ...
  return __riscv_vreinterpret_v_i64m4_i32m4(__riscv_vreinterpret_v_u64m4_i64m4(
    __riscv_vlmul_trunc_v_u64m8_u64m4(__riscv_vwmaccu_vx_u64m8(
    __riscv_vwaddu_vv_u64m8(data, data, unpacket_traits<Packet4Xi>::size), 0xffffffffu,
    data, unpacket_traits<Packet4Xi>::size))));
}

template <>
EIGEN_STRONG_INLINE Packet4Xi ploadquad<Packet4Xi>(const numext::int32_t* from) {
  Packet4Xu idx = __riscv_vsrl_vx_u32m4(__riscv_vid_v_u32m4(
     unpacket_traits<Packet4Xi>::size), 2, unpacket_traits<Packet4Xi>::size);
...
EIGEN_STRONG_INLINE Packet4Xf psignbit(const Packet4Xf& a) {
  return __riscv_vreinterpret_v_i32m4_f32m4(__riscv_vsra_vx_i32m4(
      __riscv_vreinterpret_v_f32m4_i32m4(a), 31, unpacket_traits<Packet4Xi>::size));
}
...
EIGEN_STRONG_INLINE Packet4Xf pselect(const Packet4Xf& mask, const Packet4Xf& a, const Packet4Xf& b) {
  PacketMask8 mask2 = __riscv_vmsne_vx_i32m4_b8(__riscv_vreinterpret_v_f32m4_i32m4(mask), 0,
      unpacket_traits<Packet4Xf>::size);
...
EIGEN_STRONG_INLINE Packet4Xf ploaddup<Packet4Xf>(const float* from) {
  ...
  return __riscv_vreinterpret_v_i32m4_f32m4(__riscv_vreinterpret_v_i64m4_i32m4(__riscv_vreinterpret_v_u64m4_i64m4(
    __riscv_vlmul_trunc_v_u64m8_u64m4(__riscv_vwmaccu_vx_u64m8(
    __riscv_vwaddu_vv_u64m8(data, data, unpacket_traits<Packet4Xi>::size), 0xffffffffu,
    data, unpacket_traits<Packet4Xi>::size)))));
}
...
EIGEN_STRONG_INLINE Packet4Xf ploadquad<Packet4Xf>(const float* from) {
  Packet4Xu idx = __riscv_vsrl_vx_u32m4(__riscv_vid_v_u32m4(
     unpacket_traits<Packet4Xf>::size), 2, unpacket_traits<Packet4Xf>::size);
...
EIGEN_STRONG_INLINE Packet4Xl ploaddup<Packet4Xl>(const numext::int64_t* from) {
  Packet4Xul idx = __riscv_vsrl_vx_u64m4(__riscv_vid_v_u64m4(
...
EIGEN_STRONG_INLINE Packet4Xd psignbit(const Packet4Xd& a) {
  return __riscv_vreinterpret_v_i64m4_f64m4(__riscv_vsra_vx_i64m4(
      __riscv_vreinterpret_v_f64m4_i64m4(a), 63, unpacket_traits<Packet4Xl>::size));
}
...
EIGEN_STRONG_INLINE Packet4Xd pselect(const Packet4Xd& mask, const Packet4Xd& a, const Packet4Xd& b) {
  PacketMask16 mask2 = __riscv_vmsne_vx_i64m4_b16(__riscv_vreinterpret_v_f64m4_i64m4(mask), 0,
      unpacket_traits<Packet4Xd>::size);
...
EIGEN_STRONG_INLINE Packet4Xd ploadquad<Packet4Xd>(const double* from) {
  Packet4Xul idx = __riscv_vsrl_vx_u64m4(__riscv_vid_v_u64m4(
     unpacket_traits<Packet4Xd>::size), 2, unpacket_traits<Packet4Xd>::size);
  return __riscv_vrgather_vv_f64m4(pload<Packet4Xd>(from), idx, unpacket_traits<Packet4Xd>::size);
}
...
EIGEN_STRONG_INLINE Packet4Xs ploaddup<Packet4Xs>(const numext::int16_t* from) {
  ...
  return __riscv_vreinterpret_v_i32m4_i16m4(__riscv_vreinterpret_v_u32m4_i32m4(
    __riscv_vlmul_trunc_v_u32m8_u32m4(__riscv_vwmaccu_vx_u32m8(
    __riscv_vwaddu_vv_u32m8(data, data, unpacket_traits<Packet4Xs>::size), 0xffffu,
    data, unpacket_traits<Packet4Xs>::size))));
}

template <>
EIGEN_STRONG_INLINE Packet4Xs ploadquad<Packet4Xs>(const numext::int16_t* from) {
  Packet4Xsu idx = __riscv_vsrl_vx_u16m4(__riscv_vid_v_u16m4(
     unpacket_traits<Packet4Xs>::size), 2, unpacket_traits<Packet4Xs>::size);
