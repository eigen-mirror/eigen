...
EIGEN_STRONG_INLINE Packet2Xcf pmul<Packet2Xcf>(const Packet2Xcf& a, const Packet2Xcf& b) {
  ...
  return Packet2Xcf(pmadd<Packet4Xf>(imag, pcplxflip<Packet2Xcf>(pconj<Packet2Xcf>(b)).v, pmul<Packet4Xf>(real, b.v)));
}
...
EIGEN_STRONG_INLINE Packet2Xcf pmadd<Packet2Xcf>(const Packet2Xcf& a, const Packet2Xcf& b, const Packet2Xcf& c) {
  ...
  prealimag2(a, real, imag);
  return Packet2Xcf(
      pmadd<Packet4Xf>(imag, pcplxflip<Packet2Xcf>(pconj<Packet2Xcf>(b)).v, pmadd<Packet4Xf>(real, b.v, c.v)));
}
...
EIGEN_STRONG_INLINE Packet2Xcf pmsub<Packet2Xcf>(const Packet2Xcf& a, const Packet2Xcf& b, const Packet2Xcf& c) {
  ...
  prealimag2(a, real, imag);
  return Packet2Xcf(
      pmadd<Packet4Xf>(imag, pcplxflip<Packet2Xcf>(pconj<Packet2Xcf>(b)).v, pmsub<Packet4Xf>(real, b.v, c.v)));
}
...
EIGEN_STRONG_INLINE Packet2Xcf pdup(const Packet1Xcf& a) {
  ...
  return Packet2Xcf(__riscv_vreinterpret_v_f64m4_f32m4(
...
EIGEN_STRONG_INLINE Packet1Xcfh pmul<Packet1Xcfh>(const Packet1Xcfh& a, const Packet1Xcfh& b) {
  ...
  prealimag2(a, real, imag);
  return Packet1Xcfh(
      pmadd<Packet1Xf>(imag, pcplxflip<Packet1Xcfh>(pconj<Packet1Xcfh>(b)).v, pmul<Packet1Xf>(real, b.v)));
}
...
EIGEN_STRONG_INLINE Packet1Xcfh pmadd<Packet1Xcfh>(const Packet1Xcfh& a, const Packet1Xcfh& b, const Packet1Xcfh& c) {
  ...
  prealimag2(a, real, imag);
  return Packet1Xcfh(
      pmadd<Packet1Xf>(imag, pcplxflip<Packet1Xcfh>(pconj<Packet1Xcfh>(b)).v, pmadd<Packet1Xf>(real, b.v, c.v)));
}
...
EIGEN_STRONG_INLINE Packet1Xcfh pmsub<Packet1Xcfh>(const Packet1Xcfh& a, const Packet1Xcfh& b, const Packet1Xcfh& c) {
  ...
  prealimag2(a, real, imag);
  return Packet1Xcfh(
      pmadd<Packet1Xf>(imag, pcplxflip<Packet1Xcfh>(pconj<Packet1Xcfh>(b)).v, pmsub<Packet1Xf>(real, b.v, c.v)));
}
...
EIGEN_STRONG_INLINE Packet1Xcf pdup(const Packet1Xcfh& a) {
  ...
  return Packet1Xcf(__riscv_vreinterpret_v_f64m2_f32m2(
...
template <>
EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE Packet1Xcfh
pgather<std::complex<float>, Packet1Xcfh>(const std::complex<float>* from, Index stride) {
  return Packet1Xcfh(__riscv_vreinterpret_v_i64m1_f32m1(pgather<int64_t, Packet1Xl>(
      reinterpret_cast<const numext::int64_t*>(reinterpret_cast<const void*>(from)), stride)));
}

template <>
EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE void pscatter<std::complex<float>, Packet1Xcfh>(std::complex<float>* to,
                                                                                      const Packet1Xcfh& from,
                                                                                      Index stride) {
...
EIGEN_STRONG_INLINE Packet2Xcd pmul<Packet2Xcd>(const Packet2Xcd& a, const Packet2Xcd& b) {
  Packet4Xd real, imag;
  prealimag2(a, real, imag);
  return Packet2Xcd(pmadd<Packet4Xd>(imag, pcplxflip<Packet2Xcd>(pconj<Packet2Xcd>(b)).v, pmul<Packet4Xd>(real, b.v)));
}
...
EIGEN_STRONG_INLINE Packet2Xcd pmadd<Packet2Xcd>(const Packet2Xcd& a, const Packet2Xcd& b, const Packet2Xcd& c) {
  ...
  prealimag2(a, real, imag);
  return Packet2Xcd(
      pmadd<Packet4Xd>(imag, pcplxflip<Packet2Xcd>(pconj<Packet2Xcd>(b)).v, pmadd<Packet4Xd>(real, b.v, c.v)));
}
...
EIGEN_STRONG_INLINE Packet2Xcd pmsub<Packet2Xcd>(const Packet2Xcd& a, const Packet2Xcd& b, const Packet2Xcd& c) {
  ...
  prealimag2(a, real, imag);
  return Packet2Xcd(
      pmadd<Packet4Xd>(imag, pcplxflip<Packet2Xcd>(pconj<Packet2Xcd>(b)).v, pmsub<Packet4Xd>(real, b.v, c.v)));
}
...
EIGEN_STRONG_INLINE Packet2Xcd ploaddup<Packet2Xcd>(const std::complex<double>* from) {
  ...
  Packet4Xul idx1 =
      __riscv_vsrl_vx_u64m4(__riscv_vid_v_u64m4(unpacket_traits<Packet4Xd>::size), 1, unpacket_traits<Packet4Xd>::size);
  Packet4Xul idx2 = __riscv_vxor_vx_u64m4_tumu(mask, idx1, idx1, 1, unpacket_traits<Packet4Xl>::size);
  return Packet2Xcd(__riscv_vrgather_vv_f64m4(
...
EIGEN_STRONG_INLINE Packet1Xcdh pmul<Packet1Xcdh>(const Packet1Xcdh& a, const Packet1Xcdh& b) {
  ...
  prealimag2(a, real, imag);
  return Packet1Xcdh(
      pmadd<Packet1Xd>(imag, pcplxflip<Packet1Xcdh>(pconj<Packet1Xcdh>(b)).v, pmul<Packet1Xd>(real, b.v)));
}
...
EIGEN_STRONG_INLINE Packet1Xcdh pmadd<Packet1Xcdh>(const Packet1Xcdh& a, const Packet1Xcdh& b, const Packet1Xcdh& c) {
  ...
  prealimag2(a, real, imag);
  return Packet1Xcdh(
      pmadd<Packet1Xd>(imag, pcplxflip<Packet1Xcdh>(pconj<Packet1Xcdh>(b)).v, pmadd<Packet1Xd>(real, b.v, c.v)));
}
...
EIGEN_STRONG_INLINE Packet1Xcdh pmsub<Packet1Xcdh>(const Packet1Xcdh& a, const Packet1Xcdh& b, const Packet1Xcdh& c) {
  ...
  prealimag2(a, real, imag);
  return Packet1Xcdh(
      pmadd<Packet1Xd>(imag, pcplxflip<Packet1Xcdh>(pconj<Packet1Xcdh>(b)).v, pmsub<Packet1Xd>(real, b.v, c.v)));
}
...
EIGEN_STRONG_INLINE Packet1Xcdh ploaddup<Packet1Xcdh>(const std::complex<double>* from) {
  ...
  return Packet1Xcdh(__riscv_vrgather_vv_f64m1(pload<Packet1Xd>(reinterpret_cast<const double*>(from)), idx2,
                                               unpacket_traits<Packet1Xd>::size));
}
...
template <>
EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE Packet1Xcdh
pgather<std::complex<double>, Packet1Xcdh>(const std::complex<double>* from, Index stride) {
  const PacketMask64 mask =
...
template <>
EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE void pscatter<std::complex<double>, Packet1Xcdh>(std::complex<double>* to,
                                                                                       const Packet1Xcdh& from,
                                                                                       Index stride) {
  const PacketMask64 mask =
      __riscv_vreinterpret_v_i8m1_b64(__riscv_vmv_v_x_i8m1(static_cast<char>(0x55), unpacket_traits<Packet1Xc>::size));
  double* to2 = reinterpret_cast<double*>(to);
